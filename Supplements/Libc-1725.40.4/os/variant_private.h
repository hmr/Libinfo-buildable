 ...
 */
//API_AVAILABLE(macosx(10.16)) API_UNAVAILABLE(ios, tvos, watchos, bridgeos) // {{modified-by-hmr}}
API_AVAILABLE(macosx(10.16)) API_UNAVAILABLE(ios, tvos, watchos) // {{modified-by-hmr}}
OS_EXPORT OS_WARN_RESULT
bool
 ...
 */
//API_AVAILABLE(macosx(10.15), ios(13.0), tvos(13.0), watchos(6.0), bridgeos(4.0)) // {{modified-by-hmr}}
API_AVAILABLE(macosx(10.15), ios(13.0), tvos(13.0), watchos(6.0)) // {{modified-by-hmr}}
OS_EXPORT OS_WARN_RESULT
bool
 ...
 * error.
 */
//API_AVAILABLE(macosx(10.16), ios(14.0), tvos(13.0), watchos(7.0), bridgeos(4.0)) // {{modified-by-hmr}}
API_AVAILABLE(macosx(10.16), ios(14.0), tvos(13.0), watchos(7.0)) // {{modified-by-hmr}}
OS_EXPORT OS_WARN_RESULT
